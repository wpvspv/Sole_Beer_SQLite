...
public class Liquor_Store_Soju extends Activity {
    String Liquor_kind;
    SQLiteDatabase db;
    DBHelper helper;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.liquorstore_soju);
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM contacts WHERE kind='소주'",null);
        cursor.moveToFirst();
